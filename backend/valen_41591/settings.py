"""
Django settings for valen_41591 project.
...
WSGI_APPLICATION = 'valen_41591.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "valen_41591 API",
    "DESCRIPTION": "API documentation for valen_41591 App",
    "VERSION": "v1",
}
